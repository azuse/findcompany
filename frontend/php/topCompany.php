...
$sql = "SELECT * FROM company WHERE 1 ".$hasContect.$hasAddress.$hasHomePage.$notLeagal.$city.$sort.";";
// echo $sql;
...
$sql = "SELECT COUNT(id) count FROM company WHERE company LIKE '%公司%' ".$hasContect.$hasAddress.$hasHomePage.$notLeagal.$city.$sort.";";
// echo $sql;
mysqli_select_db( $conn, 'findcompany' );
$retval = mysqli_query( $conn, $sql );
if(! $retval )
